...
#    parser.add_argument('-f', '--src',     default='main.lua',     help='Source file on computer, default main.lua')  # TJT
    parser.add_argument('-f', '--src',     default=None,	   help='Source file on computer, default main.lua')
