...
pin_input ( int gpio )
{
    easygpio_pinMode(gpio, EASYGPIO_NOPULL, EASYGPIO_INPUT);
}
...
pin_output ( int gpio )
{
    (void) easygpio_pinMode(gpio, EASYGPIO_NOPULL, EASYGPIO_OUTPUT);
}
